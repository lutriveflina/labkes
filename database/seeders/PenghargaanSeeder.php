...
class PenghargaanSeeder extends Seeder
{
    ...
    public function run()
    {
        Penghargaan::updateOrCreate([
            ...
            'nama_penghargaan' => 'Pendaftaran Dan Informasi',
        ...
        Pelayanan::updateOrCreate([
            ...
            'nama_penghargaan' => 'Kesehatan Umum',
        ...
        Pelayanan::updateOrCreate([
            ...
            'nama_penghargaan' => 'Kesehatan Ibu dan Anak',
        ...
        Pelayanan::updateOrCreate([
            ...
            'nama_penghargaan' => 'Pemeriksaan Gigi dan Mulut',
