...
<div class="card mb-4">
    ...
    <div class="card-body pt-0 pb-2">
        <form action="{{ route('admin.capaian-kerja.post') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <input type="number" class="form-control" name="id_capaian_kerja"
                    value="{{ $capaianKerja ? $capaianKerja->id : null }}" hidden>
                <div class="form-group col-md-6">
                    <label for="">Judul</label>
                    <input type="text" value="{{ $capaianKerja ? $capaianKerja->judul : null }}" name="judul"
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="col-md-6 text-center pt-3 pb-5">
                        <img src="{{$capaianKerja ? asset('storage/'. $capaianKerja->file) : null}}" alt=""
