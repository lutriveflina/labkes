            ...
            <div class="card-body pt-0 pb-2">
                <div class="table-responsive p-0">
                    <table class="table align-items-center mb-0" id="table_document">
                        ...
                        <tbody>
                            @foreach ($listCapaianKerja as $index => $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.capaian-kerja.form', ['id_capaian_kerja' => $item->id]) }}"
                                    ...
                                    <form action="{{ route('admin.capaian-kerja.delete', ['id' => $item->id]) }}"
