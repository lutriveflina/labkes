...
<div class="card mb-4">
    ...
    <div class="card-body pt-0 pb-2">
        <form action="{{ route('admin.renstra.post') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <input type="number" class="form-control" name="id_renstra" value="{{ $renstra ? $renstra->id : null }}"
                    hidden>
