        ...
        <div class="card mb-4">
            <div class="card-header pb-3">
                <div class="d-flex align-items-center justify-content-between">
                    <h6>Tata Nilai Laboratorium</h6>
                    <div>
                        <a href="{{ route('admin.tata-nilai.form') }}" class="btn btn-sm bg-gradient-primary"><i
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.tata-nilai.form', ['id_tata_nilai' => $item->id]) }}"
                                    ...
                                    <form action="{{ route('admin.tata-nilai.delete', ['id' => $item->id]) }}"
