        ...
        <div class="card mb-4">
            <div class="card-header pb-3">
                <div class="d-flex align-items-center justify-content-between">
                    <h6>Regulasi Ekternal</h6>
                    <div>
                        <a href="{{ route('admin.regulasi-eksternal.form') }}" class="btn btn-sm bg-gradient-primary"><i
            ...
            <div class="card-body pt-0 pb-2">
                <div class="table-responsive p-0">
                    <table class="table align-items-center mb-0" id="table_document">
                        ...
                        <tbody>
                            @foreach ($listRegulasiEksternal as $index => $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.regulasi-eksternal.form', ['id_regulasi_eksternal' => $item->id]) }}"
                                    ...
                                    <form action="{{ route('admin.regulasi-eksternal.delete', ['id' => $item->id]) }}"
