        ...
        <div class="card mb-4">
            <div class="card-header pb-3">
                <div class="d-flex align-items-center justify-content-between">
                    <h6>FAQ</h6>
                    <div>
                        <a href="{{ route('admin.faq.form') }}" class="btn btn-sm bg-gradient-primary"><i
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.faq.form', ['id_faq' => $item->id]) }}"
                                    ...
                                    <form action="{{ route('admin.faq.delete', ['id' => $item->id]) }}" method="POST"
