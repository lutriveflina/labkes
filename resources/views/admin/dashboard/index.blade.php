                            ...
                            <div class="col-lg-6">
                                <div class="d-flex flex-column h-100">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <p class="mb-1 pt-2 text-bold">{{ $kegiatanTerbaru[0]->pelayanan->nama_pelayanan}}</p>
                                        <small class="text-sm">{{ $kegiatanTerbaru[0]->tanggal_formatted }}</small>
                                    </div>
                                    <h5 class="font-weight-bolder">{{ $kegiatanTerbaru[0]->judul }}</h5>
                                    <div class="mb-3" style="height: 60px; overflow: hidden"><?= $kegiatanTerbaru[0]->konten ?></div>
                                ...
                                <div class="bg-gradient-primary border-radius-lg h-100">
                                    ...
                                    <div class="position-relative d-flex align-items-center justify-content-center h-100">
                                        <img class="w-100 h-100 position-relative rounded"
                                            src="{{ asset('storage/' . $kegiatanTerbaru[0]->foto_utama) }}"
                                            alt="rocket">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card h-100 p-3">
                        <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100"
                            ...
                            <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                                ...
                                <a class="text-white text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="{{ route('admin.berita-kegiatan.detail', ['id' => $kegiatanTerbaru[1]->id]) }}">
                                    Read More
                                    <i class="fas fa-arrow-right text-sm ms-1" aria-hidden="true"></i>
                                </a>
                            </div>
