        ...
        <div class="card mb-4">
            <div class="card-header pb-3">
                <div class="d-flex align-items-center justify-content-between">
                    <h6>Kategori Standar Pelayanan Laboratorium</h6>
                    <div>
                        <a href="{{ route('admin.parent-standar.form') }}" class="btn btn-sm bg-gradient-primary"><i
            ...
            <div class="card-body pt-0 pb-2">
                <div class="table-responsive p-0">
                    <table class="table align-items-center mb-0" id="table_standar_pelayanan">
                        ...
                        <tbody>
                            @foreach ($kategoriStandarPelayanan as $index => $item)
                            <tr>
                                <td class="text-sm">{{ $index + 1 }}</td>
                                <td class="text-sm">{{ $item->name }}</td>

                                <td class="text-center">
                                    <a href="{{ route('admin.parent-standar.form', ['id_standar_pelayanan' => $item->id]) }}"
                                    ...
                                    <form action="{{ route('admin.parent-standar.delete', ['id' => $item->id]) }}"
