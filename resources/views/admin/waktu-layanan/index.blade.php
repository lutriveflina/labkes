        ...
        <div class="card mb-4">
            <div class="card-header pb-3">
                <div class="d-flex align-items-center justify-content-between">
                    <h6>Waktu Layanan Laboratorium</h6>
                    <div>
                        <a href="{{ route('admin.waktu-layanan.form') }}" class="btn btn-sm bg-gradient-primary"><i
            ...
            <div class="card-body pt-0 pb-2">
                <div class="table-responsive p-0">
                    <table class="table align-items-center mb-0" id="table_standar_pelayanan">
                        ...
                        <tbody>
                            @foreach ($listWaktuLayanan as $index => $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.waktu-layanan.form', ['id_waktu_layanan' => $item->id]) }}"
                                    ...
                                    <form action="{{ route('admin.waktu-layanan.delete', ['id' => $item->id]) }}"
